...
public final class Updater {
	...
	private static final String PREFERENCE_UPDATE_URL_VERSION_MACOS = "urlMacos"; //$NON-NLS-1$
	...
	private static String getLatestVersion() {
		...
		{
			url = updaterProperties.getProperty(PREFERENCE_UPDATE_URL_VERSION_MACOS);
		}
